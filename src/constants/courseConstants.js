...
export const PREFERED_COURSES_REQUEST="PREFERED_COURSES_REQUEST";
export const PREFERED_COURSES_SUCCESS="PREFERED_COURSES_SUCCESS";
export const PREFERED_COURSES_FAIL="PREFERED_COURSES_FAIL";
