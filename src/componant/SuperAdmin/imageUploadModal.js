...
const ImageUploadModal = () => {
    ...
    const { loading, message, error } = useSelector(state => state.addCarousel);
    ...
    const handleImageUpload = () => {
        ...
        dispatch(CarouselImageUpload(formData));
    };
    ...
    useEffect(() => {
        if (message) {
            ...
            dispatch({ type: CAROUSEL_IMAGE_UPLOAD_RESET })
        }
        if (error) {
            alert.error(error);
                ...
                <div className="modal-dialog modal-dialog-scrollable modal-xl">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">CAMPUS image upload</h5>
                        ...
                        <div className="modal-body">
                            ...
                            <div>
                                <div className='bg-dark text-light p-2'>
                                    <h5 className='text-center'>Upload landing page carousel images</h5>
                                </div>
