...
import { CourseCoverimgAction, CourseLogoimgAction, CourseOtherimgAction, clearErrors } from '../../action/imageAction'
import { faEye, faMultiply, faTimes } from '@fortawesome/free-solid-svg-icons'
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import { useAlert } from 'react-alert'
import { Button } from 'antd'
import { ADD_COURSECOVER_RESET, OTHER_COURSEPHOTO_RESET } from '../../constants/imageConstants'

const CourseDataChange = () => {
    ...
    const handleImageUpload = () => {
        ...
        dispatch(CourseCoverimgAction(formData));
    };
    ...
    const handleOtherImageUpload = () => {
        ...
        dispatch(CourseOtherimgAction(formData));
    };
    ...
    const handleLogoUpload = () => {
        ...
        formData.append('course_id', id);
        dispatch(CourseLogoimgAction(formData));
    }
    ...
    useEffect(() => {
        if (message) {
            ...
            dispatch({ type: ADD_COURSECOVER_RESET })
            dispatch({ type: OTHER_COURSEPHOTO_RESET })
        }
        if (error) {
            alert.error(error);
...
export default CourseDataChange