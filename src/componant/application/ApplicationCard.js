        ...
        <Fragment>
            <div className='MyApplication container'>
                ...
                <div className='rightDiv'>
                   ...
                   { data.admission_status==='Selected'?(<Fragment> <Link to={`/admission/payment/${data.id}`} className='btn btn-primary Paybtm'>Pay Fees</Link> <span className='paynotic'>*If you dont pay your fees then your application will be rejected</span> </Fragment>):null}
